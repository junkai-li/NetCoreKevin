...
namespace kevin.Application.Services.AI
{
    public class AIFileToolService : IAIFileToolService
    {
        ...
        public string SaveFileContent([Description("文件名称如（xx.html,xx.txt）支持各种文件类型")] string fileName, [Description("本地文件地址")] string? basePath = null, [Description("文件数据内容")] string? content = null)
        {
            Console.WriteLine();
