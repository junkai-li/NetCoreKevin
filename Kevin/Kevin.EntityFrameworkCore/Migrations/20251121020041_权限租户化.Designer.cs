...
namespace Kevin.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20251121020041_权限租户化")]
    partial class 权限租户化
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("kevin.Domain.Entities.TTenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = 1000,
                            CreateTime = new DateTime(2025, 11, 21, 10, 0, 40, 499, DateTimeKind.Local).AddTicks(1022),
                            IsDelete = 0ul,
                            Name = "admin",
                            Status = 1,
                            TenantId = 0,
            ...
            modelBuilder.Entity("kevin.Domain.Kevin.TRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2025, 11, 21, 10, 0, 40, 492, DateTimeKind.Local).AddTicks(2998),
                            IsDelete = 0ul,
                            Name = "admin",
                            Remarks = "admin",
                            TenantId = 1000,
            ...
            modelBuilder.Entity("kevin.Domain.Kevin.TUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2025, 11, 21, 10, 0, 40, 498, DateTimeKind.Local).AddTicks(6731),
                            Email = "admin",
                            IsDelete = 0ul,
                            IsSuperAdmin = 1ul,
                            IsSystem = 1ul,
                            ...
                            Status = 1ul,
                            TenantId = 1000,
                            UpdateTime = new DateTime(2025, 11, 21, 10, 0, 40, 498, DateTimeKind.Local).AddTicks(6751),
                            xmin = 0u
                        });
                });
