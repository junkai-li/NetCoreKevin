    ...
    public partial class _20251124初始化数据库 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ip_address = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "Ip地址")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    device_mark = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true, comment: "设备标记")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    create_time = table.Column<DateTime>(type: "datetime(6)", nullable: false, comment: "创建时间"),
                    is_delete = table.Column<ulong>(type: "bit", nullable: false, comment: "是否删除"),
                    delete_time = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "删除时间"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("c23301b7-f9e0-464c-b76d-1f0a5a557548"), new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), null, 0ul, "admin", "admin", null, 1000, 0u });

            migrationBuilder.InsertData(
                table: "t_tenant",
                columns: new[] { "id", "code", "create_time", "delete_time", "is_delete", "name", "row_version", "status", "tenant_id", "update_time", "xmin" },
                values: new object[] { new Guid("1b4f94ac-b697-4cbe-9626-6cd2de627538"), 1000, new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), null, 0ul, "admin", null, 1, 0, null, 0u });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("eef5525d-5d64-46ad-8d64-79fb3ad9724f"), new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), null, "admin", 0ul, 1ul, 1ul, "admin", "admin", "8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918", "admin", null, null, 1ul, 1000, null, 0u });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("eef5525d-5d64-46ad-8d64-72fb3ad9728f"), new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), new Guid("eef5525d-5d64-46ad-8d64-79fb3ad9724f"), null, null, 0ul, new Guid("c23301b7-f9e0-464c-b76d-1f0a5a557548"), null, 1000, null, null, new Guid("eef5525d-5d64-46ad-8d64-79fb3ad9724f"), 0u });
