...
namespace Kevin.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20251119080044_初始化默认索引")]
    partial class 初始化默认索引
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("kevin.Domain.Entities.TTenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = 1000,
                            CreateTime = new DateTime(2025, 11, 19, 16, 0, 43, 995, DateTimeKind.Local).AddTicks(6998),
                            IsDelete = 0ul,
                            Name = "admin",
                            Status = 1,
                            TenantId = 0,
            ...
            modelBuilder.Entity("kevin.Domain.Kevin.TRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2025, 11, 19, 16, 0, 43, 989, DateTimeKind.Local).AddTicks(156),
                            IsDelete = 0ul,
                            Name = "admin",
                            Remarks = "admin",
                            TenantId = 1000,
            ...
            modelBuilder.Entity("kevin.Domain.Kevin.TUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2025, 11, 19, 16, 0, 43, 994, DateTimeKind.Local).AddTicks(9719),
                            Email = "admin",
                            IsDelete = 0ul,
                            IsSuperAdmin = 1ul,
                            IsSystem = 1ul,
                            ...
                            Status = 1ul,
                            TenantId = 1000,
                            UpdateTime = new DateTime(2025, 11, 19, 16, 0, 43, 994, DateTimeKind.Local).AddTicks(9734),
                            xmin = 0u
                        });
                });
