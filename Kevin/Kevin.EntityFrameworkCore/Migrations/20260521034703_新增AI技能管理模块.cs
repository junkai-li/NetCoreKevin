...
{
    /// <inheritdoc />
    public partial class 新增AI技能管理模块 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    model_description = table.Column<string>(type: "longtext", nullable: true, comment: "部署名，azure需要使用")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    embedding_value_size = table.Column<int>(type: "int", nullable: false, comment: "矢量值大小"),
                    create_time = table.Column<DateTime>(type: "datetime(6)", nullable: false, comment: "创建时间"),
                    is_delete = table.Column<ulong>(type: "bit", nullable: false, comment: "是否删除"),
                    delete_time = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "删除时间"),
                    row_version = table.Column<Guid>(type: "char(36)", nullable: true, comment: "行版本标记", collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateTable(
                name: "t_a_i_skill_tool_management",
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false, comment: "主键标识ID")
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    name = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false, comment: "名称")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    class_method = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false, comment: "方法")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    url = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true, comment: "路径")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    description = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true, comment: "描述")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    is_system = table.Column<ulong>(type: "bit", nullable: false, comment: "是否系统内置工具（系统内置工具不允许删除和修改）"),
                    skill_tool_type = table.Column<int>(type: "int", nullable: false, comment: "技能工具类型"),
                    create_time = table.Column<DateTime>(type: "datetime(6)", nullable: false, comment: "创建时间"),
                    is_delete = table.Column<ulong>(type: "bit", nullable: false, comment: "是否删除"),
                    delete_time = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "删除时间"),
                    row_version = table.Column<Guid>(type: "char(36)", nullable: true, comment: "行版本标记", collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_a_i_skill_tool_management", x => x.id);
                    table.ForeignKey(
                        name: "FK_t_a_i_skill_tool_management_t_user_create_user_id",
                        column: x => x.create_user_id,
                        principalTable: "t_user",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_t_a_i_skill_tool_management_t_user_delete_user_id",
                        column: x => x.delete_user_id,
                        principalTable: "t_user",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_t_a_i_skill_tool_management_t_user_update_user_id",
                        column: x => x.update_user_id,
                        principalTable: "t_user",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false, comment: "主键标识ID")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    create_time = table.Column<DateTime>(type: "datetime(6)", nullable: false, comment: "创建时间"),
                    is_delete = table.Column<ulong>(type: "bit", nullable: false, comment: "是否删除"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    a_i_models_id = table.Column<long>(type: "bigint", nullable: true, comment: "矢量化模型Id"),
                    create_time = table.Column<DateTime>(type: "datetime(6)", nullable: false, comment: "创建时间"),
                    is_delete = table.Column<ulong>(type: "bit", nullable: false, comment: "是否删除"),
                    delete_time = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "删除时间"),
                    row_version = table.Column<Guid>(type: "char(36)", nullable: true, comment: "行版本标记", collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_t_a_i_kmss_t_a_i_models_a_i_models_id",
                        column: x => x.a_i_models_id,
                        principalTable: "t_a_i_models",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "t_a_i_skill_tool_bind_id",
                columns: table => new
                {
                    id = table.Column<long>(type: "bigint", nullable: false, comment: "主键标识ID")
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    a_i_skill_tool_management_id = table.Column<long>(type: "bigint", nullable: false, comment: "AISkillToolManagementId"),
                    bind_id = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false, comment: " 关联Id （TAIApps Id）（TUser Id）  TRole Id")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    create_time = table.Column<DateTime>(type: "datetime(6)", nullable: false, comment: "创建时间"),
                    is_delete = table.Column<ulong>(type: "bit", nullable: false, comment: "是否删除"),
                    delete_time = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "删除时间"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_a_i_skill_tool_bind_id", x => x.id);
                    table.ForeignKey(
                        name: "FK_t_a_i_skill_tool_bind_id_t_a_i_skill_tool_management_a_i_ski~",
                        column: x => x.a_i_skill_tool_management_id,
                        principalTable: "t_a_i_skill_tool_management",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_t_a_i_skill_tool_bind_id_t_user_create_user_id",
                        column: x => x.create_user_id,
                        principalTable: "t_user",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_t_a_i_skill_tool_bind_id_t_user_delete_user_id",
                        column: x => x.delete_user_id,
                        principalTable: "t_user",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_t_a_i_skill_tool_bind_id_t_user_update_user_id",
                        column: x => x.update_user_id,
                        principalTable: "t_user",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    permission_id = table.Column<string>(type: "varchar(100)", nullable: true, comment: "权限编号")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    create_time = table.Column<DateTime>(type: "datetime(6)", nullable: false, comment: "创建时间"),
                    is_delete = table.Column<ulong>(type: "bit", nullable: false, comment: "是否删除"),
                    delete_time = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "删除时间"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    a_i_prompt_i_d = table.Column<long>(type: "bigint", nullable: true, comment: "提示词Id"),
                    msg_type = table.Column<int>(type: "int", nullable: false, comment: "msg_type"),
                    create_time = table.Column<DateTime>(type: "datetime(6)", nullable: false, comment: "创建时间"),
                    is_delete = table.Column<ulong>(type: "bit", nullable: false, comment: "是否删除"),
                    delete_time = table.Column<DateTime>(type: "datetime(6)", nullable: true, comment: "删除时间"),
                    row_version = table.Column<Guid>(type: "char(36)", nullable: true, comment: "行版本标记", collation: "ascii_general_ci"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 4514140314251222771L, new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), null, "admin", 0ul, 1ul, 1ul, "admin", "admin", "8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92", "admin", null, null, 1ul, 1000, null, 0u });

            migrationBuilder.InsertData(
                table: "t_a_i_prompts",
                columns: new[] { "id", "create_time", "create_user_id", "delete_time", "delete_user_id", "description", "is_delete", "name", "prompt", "row_version", "tenant_id", "update_time", "update_user_id", "xmin" },
                values: new object[] { 4514141254257227771L, new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "AI工具智能体提示词", 0ul, "AI工具智能体提示词", "你是一个能调用工具的智能助手。 \r\n                            规则：\r\n                            1. 能用工具解决的问题必须调用工具，禁止编造。\r\n                            2. 工具定义由系统注入，严格按照要求的参数格式调用。\r\n                            3. 收到工具结果后，用自然语言总结回复，不输出原始数据。\r\n                            4. 信息不足时先向用户确认，再调用工具。\r\n                            5. 工具报错就如实说明，并建议替代方案。 \r\n                            输出：直接给出最终答案，简洁、准确，必要时用 markdown 排版。", null, 1000, null, null, 0u });

            migrationBuilder.InsertData(
                table: "t_a_i_skill_tool_management",
                columns: new[] { "id", "class_method", "create_time", "create_user_id", "delete_time", "delete_user_id", "description", "is_delete", "is_system", "name", "row_version", "skill_tool_type", "tenant_id", "update_time", "update_user_id", "url", "xmin" },
                values: new object[,]
                {
                    { 4514141254257227711L, "AgentHttpClientTools.GetAsync", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "通用 HTTP 工具 发送 GET 请求", 0ul, 1ul, "发送 GET 请求", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227712L, "AgentHttpClientTools.PostAsync", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "通用 HTTP 工具 发送 POST 请求", 0ul, 1ul, "发送 POST 请求", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227713L, "AgentHttpClientTools.PutAsync", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "通用 HTTP 工具 发送 PUT 请求", 0ul, 1ul, "发送 PUT 请求", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227714L, "AgentHttpClientTools.DeleteAsync", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "通用 HTTP 工具 发送 DELETE 请求", 0ul, 1ul, "发送 DELETE 请求", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227715L, "ShellTools.RunShell", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "通过操作系统原生 Shell 执行命令", 0ul, 1ul, "执行 Shell 命令", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227716L, "PythonTools.RunPythonPy", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "执行Python脚本", 0ul, 1ul, "执行Python脚本", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227717L, "PythonTools.RunPythonCode", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "执行Python代码", 0ul, 1ul, "执行Python代码", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227718L, "CommonTools.GetRuntimePlatform", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "用于获取当前运行在什么系统平台上", 0ul, 1ul, "获取系统", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227719L, "CommonTools.GetDesktopPath", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "获取当前系统桌面路径。 用于获取当前用户的桌面路径", 0ul, 1ul, "获取当前系统桌面路径。", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227720L, "CommonTools.WriteTextToDesktop", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "用于把各种文件输出到桌面", 0ul, 1ul, "输出文件到系统桌面", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227721L, "iKevinAITasksService.AddOrUpdateCronTask", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "创建或更新一个周期性自动任务", 0ul, 1ul, "创建或更新一个周期性自动任务", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227722L, "iKevinAITasksService.RemoveCronTask", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "移除周期性任务", 0ul, 1ul, "移除周期性任务", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227723L, "iKevinAITasksService.TriggerCronTask", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "立即触发某个周期性任务一次   ", 0ul, 1ul, "立即触发某个周期性任务一次", null, 1, 1000, null, null, "", 0u },
                    { 4514141254257227724L, "iKevinAITasksService.GetTaskList", new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), 4514140314251222771L, null, null, "获取我的所有周期性任务列表", 0ul, 1ul, "获取我的所有周期性任务列表", null, 1, 1000, null, null, "", 0u }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_kmss_a_i_models_id",
                table: "t_a_i_kmss",
                column: "a_i_models_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_bind_id_a_i_skill_tool_management_id",
                table: "t_a_i_skill_tool_bind_id",
                column: "a_i_skill_tool_management_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_bind_id_create_time",
                table: "t_a_i_skill_tool_bind_id",
                column: "create_time");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_bind_id_create_user_id",
                table: "t_a_i_skill_tool_bind_id",
                column: "create_user_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_bind_id_delete_time",
                table: "t_a_i_skill_tool_bind_id",
                column: "delete_time");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_bind_id_delete_user_id",
                table: "t_a_i_skill_tool_bind_id",
                column: "delete_user_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_bind_id_tenant_id",
                table: "t_a_i_skill_tool_bind_id",
                column: "tenant_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_bind_id_update_time",
                table: "t_a_i_skill_tool_bind_id",
                column: "update_time");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_bind_id_update_user_id",
                table: "t_a_i_skill_tool_bind_id",
                column: "update_user_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_management_create_time",
                table: "t_a_i_skill_tool_management",
                column: "create_time");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_management_create_user_id",
                table: "t_a_i_skill_tool_management",
                column: "create_user_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_management_delete_time",
                table: "t_a_i_skill_tool_management",
                column: "delete_time");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_management_delete_user_id",
                table: "t_a_i_skill_tool_management",
                column: "delete_user_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_management_tenant_id",
                table: "t_a_i_skill_tool_management",
                column: "tenant_id");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_management_update_time",
                table: "t_a_i_skill_tool_management",
                column: "update_time");

            migrationBuilder.CreateIndex(
                name: "IX_t_a_i_skill_tool_management_update_user_id",
                table: "t_a_i_skill_tool_management",
                column: "update_user_id");
