...
namespace Kevin.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20251119052612_更新用户表结构")]
    partial class 更新用户表结构
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("kevin.Domain.Entities.TTenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = 1000,
                            CreateTime = new DateTime(2025, 11, 19, 13, 26, 11, 291, DateTimeKind.Local).AddTicks(3334),
                            IsDelete = 0ul,
                            Name = "admin",
                            Status = 1,
                            TenantId = 0,
            ...
            modelBuilder.Entity("kevin.Domain.Kevin.TRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2025, 11, 19, 13, 26, 11, 281, DateTimeKind.Local).AddTicks(7339),
                            IsDelete = 0ul,
                            Name = "admin",
                            Remarks = "admin",
                            TenantId = 1000,
            ...
            modelBuilder.Entity("kevin.Domain.Kevin.TUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2025, 11, 19, 13, 26, 11, 290, DateTimeKind.Local).AddTicks(3424),
                            Email = "admin",
                            IsDelete = 0ul,
                            IsSuperAdmin = 1ul,
                            IsSystem = 1ul,
                            ...
                            Status = 1ul,
                            TenantId = 1000,
                            UpdateTime = new DateTime(2025, 11, 19, 13, 26, 11, 290, DateTimeKind.Local).AddTicks(3462),
                            xmin = 0u
                        });
                });
