...
- [AIAppsService.cs:16-545](file://Kevin/Application/Services/AI/AIAppsService.cs#L16-L545)
- [TAIApps.cs:9-216](file://Kevin/Domain/Entities/AI/TAIApps.cs#L9-L216)
- [TAIModels.cs:8-67](file://Kevin/Domain/Entities/AI/TAIModels.cs#L8-L67)
...
- [AIAppsService.cs:57-545](file://Kevin/Application/Services/AI/AIAppsService.cs#L57-L545)
- [AIAppsDto.cs:7-264](file://Kevin/kevin.Share/Dtos/AI/AIAppsDto.cs#L7-L264)
- [TAIApps.cs:9-216](file://Kevin/Domain/Entities/AI/TAIApps.cs#L9-L216)
...
- [AIAppsService.cs:321-449](file://Kevin/Application/Services/AI/AIAppsService.cs#L321-L449)
...
章节来源
- [TAIApps.cs:13-216](file://Kevin/Domain/Entities/AI/TAIApps.cs#L13-L216)
- [AIAppsDto.cs:42-263](file://Kevin/kevin.Share/Dtos/AI/AIAppsDto.cs#L42-L263)
...
- [AIAppsService.cs:170-259](file://Kevin/Application/Services/AI/AIAppsService.cs#L170-L259)
- [AIAppsService.cs:321-449](file://Kevin/Application/Services/AI/AIAppsService.cs#L321-L449)
- [AIAppsService.cs:460-542](file://Kevin/Application/Services/AI/AIAppsService.cs#L460-L542)
...
## 结论
AI应用管理提供了完整的创建、配置、启用/禁用、模型选择、参数调优、权限与绑定、生命周期管理与监控能力。通过TAIApps的丰富配置项，可以灵活适配不同场景的AI需求，并结合知识库、提示词、工具与技能构建强大的智能体。建议在上线前充分评估温度、token限制、重试与超时、日志开关等参数，确保稳定性与成本可控。
