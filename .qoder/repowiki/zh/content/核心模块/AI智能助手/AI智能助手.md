...
## 简介
本模块提供企业级AI智能助手能力，覆盖AI应用管理、聊天对话、知识库（RAG）管理、技能与工具注册使用等核心功能。系统支持多模型接入、流式响应、上下文记忆压缩、文件处理、代码执行、MCP协议工具集成等高级特性，并提供完整的Web API与前端页面支撑。
...
- [AIAgentToolSkillService.cs:16-381](file://Kevin/Application/Services/AI/AIAgentToolSkillService.cs#L16-L381)
...
## 结论
本AI智能助手模块提供了完整的AI应用生命周期管理与对话能力，结合RAG、工具/技能扩展、流式响应与上下文压缩，满足企业级复杂场景需求。通过统一的Agent框架与模块化设计，系统具备良好的可扩展性与可维护性。建议在生产环境结合业务特点调优模型参数、工具范围与知识库策略，以获得最佳性能与体验。
